...
export default function AlberguesStack() {
    return (
        <Stack.Navigator>
            <Stack.Screen name="ListaAlbergues" component={AlberguesListScreen} options={{title: "Albergues", headerBackVisible: false,}}/>
            <Stack.Screen name="MapaAlbergues" component={AlberguesMapScreen} options={{title: "Mapa de Albergues"}}/>
            <Stack.Screen name="DetalleAlbergue" component={AlbergueDetailScreen}  options={({ route, navigation }) => {
